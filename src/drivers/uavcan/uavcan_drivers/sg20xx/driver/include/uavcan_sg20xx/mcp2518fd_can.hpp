...
namespace mcp2518fd_can {
    ...
    constexpr unsigned long cINSTRUCTION_READ_CRC       = 0x0B;
    constexpr unsigned long cINSTRUCTION_WRITE          = 0x02;
    constexpr unsigned long cINSTRUCTION_WRITE_CRC      = 0x0A;
    constexpr unsigned long cINSTRUCTION_WRITE_SAFE     = 0x0C;

    /* CANFD Controller Register */
    constexpr unsigned long cREGADDR_CiCON              = 0x000;
    constexpr unsigned long cREGADDR_CiNBTCFG           = 0x004;
    constexpr unsigned long cREGADDR_CiDBTCFG           = 0x008;
    constexpr unsigned long cREGADDR_CiTDC              = 0x00C;

    constexpr unsigned long cREGADDR_CiTBC              = 0x010;
    constexpr unsigned long cREGADDR_CiTSCON            = 0x014;
    constexpr unsigned long cREGADDR_CiVEC              = 0x018;
    constexpr unsigned long cREGADDR_CiINT              = 0x01C;
    constexpr unsigned long cREGADDR_CiINTFLAG          = cREGADDR_CiINT;
    constexpr unsigned long cREGADDR_CiINTENABLE        = (cREGADDR_CiINT + 2);

    constexpr unsigned long cREGADDR_CiRXIF             = 0x020;
    constexpr unsigned long cREGADDR_CiTXIF             = 0x024;
    constexpr unsigned long cREGADDR_CiRXOVIF           = 0x028;
    constexpr unsigned long cREGADDR_CiTXATIF           = 0x02C;

    constexpr unsigned long cREGADDR_CiTXREQ            = 0x030;
    constexpr unsigned long cREGADDR_CiTREC             = 0x034;
    constexpr unsigned long cREGADDR_CiBDIAG0           = 0x038;
    constexpr unsigned long cREGADDR_CiBDIAG1           = 0x03C;

    constexpr unsigned long cREGADDR_CiTEFCON           = 0x040;
    constexpr unsigned long cREGADDR_CiTEFSTA           = 0x044;
    constexpr unsigned long cREGADDR_CiTEFUA            = 0x048;
    constexpr unsigned long cREGADDR_CiFIFOBA           = 0x04C;

    constexpr unsigned long cREGADDR_CiFIFOCON          = 0x050;
    constexpr unsigned long cREGADDR_CiFIFOSTA          = 0x054;
    constexpr unsigned long cREGADDR_CiFIFOUA           = 0x058;
    constexpr unsigned long CiFIFO_OFFSET               = (3 * 4);

    constexpr unsigned long cREGADDR_CiTXQCON           = 0x050;
    constexpr unsigned long cREGADDR_CiTXQSTA           = 0x054;
    constexpr unsigned long cREGADDR_CiTXQUA            = 0x058;

    /* Filter Register */
    constexpr unsigned long cREGADDR_CiFLTCON           = (cREGADDR_CiFIFOCON + (CiFIFO_OFFSET * CAN_FIFO_TOTAL_CHANNELS));
    constexpr unsigned long cREGADDR_CiFLTOBJ           = (cREGADDR_CiFLTCON + CAN_FIFO_TOTAL_CHANNELS);
    constexpr unsigned long cREGADDR_CiMASK             = (cREGADDR_CiFLTOBJ + 4);
    constexpr unsigned long CiFILTER_OFFSET             = (2 * 4);

    /* MCP25xxFD Specific */
    constexpr unsigned long cREGADDR_OSC                = 0xE00;
    constexpr unsigned long cREGADDR_IOCON              = 0xE04;
    ...
    typedef uint32_t CAN_MSG_TIMESTAP;
    ...
    constexpr unsigned long CAN_125K_500K = ( 4UL << 24) | (125000UL);
    constexpr unsigned long CAN_250K_500K = ( 2UL << 24) | (250000UL);
    constexpr unsigned long CAN_250K_750K = ( 3UL << 24) | (250000UL);
    constexpr unsigned long CAN_250K_1M   = ( 4UL << 24) | (250000UL);
    constexpr unsigned long CAN_250K_1M5  = ( 6UL << 24) | (250000UL);
    constexpr unsigned long CAN_250K_2M   = ( 8UL << 24) | (250000UL);
    constexpr unsigned long CAN_250K_3M   = (12UL << 24) | (250000UL);
    constexpr unsigned long CAN_250K_4M   = (16UL << 24) | (250000UL);
    constexpr unsigned long CAN_500K_1M   = ( 2UL << 24) | (500000UL);
    constexpr unsigned long CAN_500K_2M   = ( 4UL << 24) | (500000UL);
    constexpr unsigned long CAN_500K_3M   = ( 6UL << 24) | (500000UL);
    constexpr unsigned long CAN_500K_4M   = ( 8UL << 24) | (500000UL);
    constexpr unsigned long CAN_500K_5M   = (10UL << 24) | (500000UL);
    constexpr unsigned long CAN_500K_6M5  = (13UL << 24) | (500000UL);
    constexpr unsigned long CAN_500K_8M   = (16UL << 24) | (500000UL);
    constexpr unsigned long CAN_500K_10M  = (20UL << 24) | (500000UL);
    constexpr unsigned long CAN_1000K_4M  = ( 4UL << 24) |(1000000UL);
    constexpr unsigned long CAN_1000K_8M  = ( 8UL << 24) |(1000000UL);
    ...
    const uint32_t canFifoResetValues[] = {0x00600400, 0x00000000, 0x00000000};
    ...
    const uint32_t mcp25xxfdControlResetValues[] = {0x00000460, 0x00000003, 0x00000000, 0x00000000, 0x00000000};
